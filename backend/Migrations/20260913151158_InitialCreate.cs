        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoorNumber = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyState = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolderUserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KeyTransactions_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_KeyTransactions_Users_HolderUserId",
                        column: x => x.HolderUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KeyTransactions_Users_IssuedByUserId",
                        column: x => x.IssuedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KeyTransactions_Users_ReturnedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyTransactions_HolderUserId",
                table: "KeyTransactions",
                column: "HolderUserId");

            migrationBuilder.CreateIndex(
                name: "IX_KeyTransactions_IssuedByUserId",
                table: "KeyTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyTransactions_ReservationId",
                table: "KeyTransactions",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_KeyTransactions_ReturnedToUserId",
                table: "KeyTransactions",
